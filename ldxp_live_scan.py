#!/usr/bin/env python3
import concurrent.futures, datetime, gzip, html, json, random, re, time, urllib.request
...
def post(path,payload,referer,retries=3):
    ...
    headers={'accept':'application/json, text/plain, */*','content-type':'application/json','origin':BASE,'referer':referer,'user-agent':UA,'visitorid':'live-scan'}
    last=None
